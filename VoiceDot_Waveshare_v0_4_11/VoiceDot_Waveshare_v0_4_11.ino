/*
  ...
  IMPORTANT:
    This version deliberately focuses on a reliable board bring-up:
      ...
      - first Home Assistant TTS WAV/PCM playback over ES8311
...
static const char* FW_VERSION = "0.4.11-test";
...
bool playMp3TtsUrl(const String &url) {
  (void)url;
  wakeTtsStatus = "MP3 deaktiviert: ESP8266Audio kollidiert mit Legacy-I2S.";
  return false;
}
