...
`v0.5.2-test` moves the local audio base to the new ESP-IDF I2S STD driver, records a
...
This build adds verbose serial diagnostics for the current re-wake/TTS hang test.
