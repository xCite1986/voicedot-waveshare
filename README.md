...
`v0.5.5-test` moves the local audio base to the new ESP-IDF I2S STD driver, records a
...
This build plays MP3 TTS in an isolated task with a watchdog so the web UI and re-wake
guard stay responsive while the decoder is tested.
