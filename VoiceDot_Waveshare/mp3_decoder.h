/*
 * Third-party code, not part of this project's own sources.
 * Based on the Helix MP3 decoder by RealNetworks (RPSL/RCSL) and taken from
 * the ESP32-audioI2S project (GPL-3.0), https://github.com/schreibfaul1/ESP32-audioI2S
 * Its own licence terms continue to apply; see README.md.
 */
